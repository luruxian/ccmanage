...
const Dashboard: React.FC = () => {
  ...
  const renderPackagesTab = () => (
    <SubscriptionPlans
      onDayCardClick={() => window.open('https://buy.example.com/day', '_blank')}
      onWeekCardClick={() => window.open('https://buy.example.com/week', '_blank')}
      onMonthCardClick={() => window.open('https://buy.example.com/month', '_blank')}
    />
  );
